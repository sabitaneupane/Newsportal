        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xm-12">
           ...
           <div class="container-fluid">
               <div class="topnav pull-right">
                <a href="index.php" <?php if($page == 'home'){ echo 'class="activenav"';} ?> >Home</a>
                <a href="about.php"  <?php if($page == 'about'){ echo 'class="activenav"';} ?>>About</a>
                <a href="contact.php" <?php if($page == 'contact'){ echo 'class="activenav"';} ?>>Contact</a>
               </div>
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-md-8 col-sm-8 col-xm-12 ">
               <a class="navbar-brand pull-right" href="" id="adbanner"> <img src="img/adbanner.png" class="img-respnsive" > </a>
          </div>
          <div class="clearfix"></div>
