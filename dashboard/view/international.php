<?php $page = 'international' ?>
<?php include('header.php') ?>

<!-- ********* section starts ******** --> 
<div id="section">
	<div class="postpage_info">
			<div class="container-fluid"   id="international_container" >
				<div>
					<h1> International </h1>
					<form>
						...
						<div  id="postpage_content" > 
							<label>  Description(short) </label> <br/>
							<textarea rows="3" name="" id="" > </textarea> 
						</div><br/>

						<div  id="postpage_content" > 
							<label>  Description(Long) </label> <br/>
		...
		<table class="table table-striped table-bordered table-hover table-condensed">
			...
			<tbody>
				<tr>
					...
					<td>2017/6/4</td>
					<td>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,mquis</td>
					...
					<td><img src="../assets/img/newsimg/footballplayer.jpg" id="postingpageimg"> </td>
